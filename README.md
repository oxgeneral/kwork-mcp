...
> **Claude:** 2 непрочитанных: user123 спрашивает про сроки, designer_pro благодарит за заказ.

> **Вы:** Что на бирже по Python?
> **Claude:** 9 проектов. Интересный: "Telegram-бот для магазина" за 15 000₽, 0 откликов, осталось 18 часов.

> **Вы:** Покажи детали заказа #12345
> **Claude:** Парсер каталога, 5 000₽, заказчик user123. В чате 12 сообщений, последнее от заказчика...
